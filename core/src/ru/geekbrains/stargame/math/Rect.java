...
public class Rect {
    ...
    //первый конструктор позволяет проинициализировать прямоугольник из другого прямоугольника
    public Rect(Rect from) {
        this(from.pos.x, from.pos.y, from.getHalfWidth(), from.getHalfHeight());
    }

    //этот конструктор уже из чисел
   ...
   //поззволяет узнать, что некий вектор  touch попал в наш прямоугольник
    ...
    //например,не столкнулись ли два наших корабля
